## rosidl (kilted) - 4.9.8-1

The packages in the `rosidl` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rosidl` on `Mon, 13 Jul 2026 14:35:30 -0000`
...
## rosidl (kilted) - 4.9.7-1

The packages in the `rosidl` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rosidl` on `Thu, 02 Jul 2026 09:06:17 -0000`
...
## rosidl (rolling) - 5.3.1-2

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl` on `Fri, 05 Jun 2026 16:30:08 -0000`
...
## rosidl (rolling) - 5.3.1-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl` on `Fri, 05 Jun 2026 16:21:55 -0000`
...
## rosidl (humble) - 3.1.9-1

The packages in the `rosidl` repository were released into the `humble` distro by running `/home/emerson/dev/ros/humble/.venv/bin/bloom-release --rosdistro humble rosidl` on `Thu, 04 Jun 2026 23:04:09 -0000`
...
## rosidl (jazzy) - 4.6.8-1

The packages in the `rosidl` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy rosidl` on `Tue, 02 Jun 2026 08:44:29 -0000`
...
## rosidl (rolling) - 5.3.0-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl` on `Wed, 06 May 2026 18:16:17 -0000`
...
## rosidl (rolling) - 5.2.0-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release rosidl -r rolling -t rolling` on `Fri, 24 Apr 2026 23:50:30 -0000`
...
## rosidl (rolling) - 5.1.5-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bin/bloom-release rosidl -r rolling` on `Fri, 24 Apr 2026 16:04:38 -0000`
...
## rosidl (rolling) - 5.1.4-2

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl` on `Thu, 09 Apr 2026 10:28:07 -0000`
...
## rosidl (rolling) - 5.1.4-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl` on `Thu, 09 Apr 2026 09:46:13 -0000`
...
## rosidl (rolling) - 5.1.3-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl` on `Tue, 24 Mar 2026 09:58:06 -0000`
...
## rosidl (humble) - 3.1.8-1

The packages in the `rosidl` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble rosidl` on `Tue, 09 Dec 2025 11:03:46 -0000`
...
## rosidl (jazzy) - 4.6.7-1

The packages in the `rosidl` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy rosidl` on `Tue, 09 Dec 2025 10:56:16 -0000`
...
## rosidl (kilted) - 4.9.6-1

The packages in the `rosidl` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rosidl` on `Tue, 09 Dec 2025 10:44:47 -0000`
...
## rosidl (rolling) - 5.1.0-1

The packages in the `rosidl` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosidl` on `Sun, 05 Oct 2025 22:48:22 -0000`
